                    ...
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-12">
                            <div class="error__content text-center">
                                <h2 style="font-weight:700;font-size:70px;line-height:80px;">Oops</h2>
                               
                                <p  style="font-size:22px" class="mt-30">Something Went Wrong Please Try again..
                                   </p>
