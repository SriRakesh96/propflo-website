...
<head>
    <!-- Contact Us - PropFlo -->
    <title>Contact Us - PropFlo</title>
    <meta name="title" content="Contact Us - PropFlo">
    <meta name="description"
        content="Get in touch with the PropFlo team. Convert leads to buyers with AI-powered sales automation and improve customer satisfaction. Contact us now!">
    <?php
      include('head.php');
            ...
            <div class="container my-5 pt-60" id="for">
                <div class="row align-items-center demo-section">
                    ...
                    <div class="col-md-6 left-content" id="contact-img">
                        <img src="assets/img/awarded.png" alt="Recognition and Awards" width="100%">
                    </div>
                    <!-- Right Content (Form Section) -->
                    <div class="col-md-6 mt-20">
                        <h3 class="section-title text-center" style="margin-bottom: 5px;"> Contact Sales
                        </h3>
