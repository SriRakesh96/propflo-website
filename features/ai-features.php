...
<head>
    <!-- Artificial Intelligence in Real Estate | PropFlo -->
    <title>Artificial Intelligence in Real Estate | PropFlo</title>
    <meta name="title" content="Artificial Intelligence in Real Estate | PropFlo">
    <meta name="description"
        content="Discover PropFlo’s AI-powered solutions for real estate, including AI web bots, content writers, data analysts, and more. Register for a demo now!">
    <?php
      include('head.php');
...
<body>
        ...
        <main>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-sm-12">
                            <p class="banner-tag wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="1500ms"
                                style="text-transform: uppercase;">AI Features</p>
                            <div class="banner-three__content text-center">
                                <style>
                                ...
                                <h1 style="color:#fff;" class="wow fadeInUp" data-wow-delay="400ms"
                                    ...
                                    <img src="aiico.png" id="im"> It’s Not Magic, Its AI—Put AI to Work For People

                                </h1>
                                <p style="color:#fff;" class="wow fadeInUp mb-30" data-wow-delay="800ms"
                                    data-wow-duration="2000ms">
                                    Accelerate your real estate sales and build stronger customer relationships with
                                    PropFlo.AI
            ...
            <div class="container">
                <div class="section-header mt-20 mb-20 text-center">
                    <h2 class="fw-600 wow splt-txt" data-splitting>Drive More Revenue with AI-Driven Real Estate CRM
                    </h2>
                    <p class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="2500ms">
                        Use AI in real estate business management to the next level with AI solutions like 24/7 AI sales
                        assistant, AI content creator for real estate, AI-based lead scoring, an Ad copywriter and an AI
                        data analyst and scale your business to new heights with PropFlo’s AI-based CRM.
                    </p>
                </div>
                    ...
                    <div class="row">
                        <div class="lead-management scroll-row d-flex flex-wrap align-items-center">
                            <div class="col-md-6 col-12 order-1 order-md-2">
                                <img class="img-fluid" src="../assets/img/ai-features/ai1.png" alt="Dynamic Image">
                            </div>
                            <div class="col-md-6 col-12 order-2 order-md-1">
                                <div id="section-1" class="lmcont">
                                    <p class="fea-tag">AI sales assistant
                                    ...
                                    <p>PropFlo’s AI Web Bot engages website visitors anytime, providing instant
                                        responses, scheduling calls and site visits, and offering customizable user
                                        interfaces and engagement flows. Easily train it using documents, brochures, or
                                        website content for personalized support.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="lead-management scroll-row d-flex flex-wrap align-items-center">
                            <div class="col-md-6 col-12 order-2 order-md-2">
                                <div id="section-2" class="lmcont">
                                    <p class="fea-tag">AI Content Writer

                                    </p>
                                    <h3 class="fw-bold mb-15">Generate Unique and Human-like content in seconds
                                    </h3>
                                    <p>Adjust the creativity level or tone to generate perfect real estate content for
                                        your business. Make customized WhatsApp and email templates and follow-up
                                        messages with AI content writers and start writing 10x faster with AI. </p>
                                </div>
                            </div>
                            <div class="col-md-6 col-12 order-1 order-md-1" style="background:#fff !important;">

                                <video autoplay loop muted playsinline style="width:100%">
                                    <source src="../assets/img/videos/ai2.mp4" type="video/mp4">
                        ...
                        <div class="lead-management scroll-row d-flex flex-wrap align-items-center">
                            <div class="col-md-6 col-12 order-1 order-md-2">
                                <img class="img-fluid" src="../assets/img/ai-features/ai3.png" alt="Dynamic Image">
                            </div>
                            <div class="col-md-6 col-12 order-2 order-md-1">
                                <div id="section-3" class="lmcont">
                                    <p class="fea-tag">AI Based Lead Scoring


                                    </p>
                                    <h3 class="fw-bold mb-15">Use Lead Scoring to Prioritize Lead Follow-ups</h3>
                                    <p>AI-based lead scoring technique ranks leads based on their likelihood to convert,
                                        helping your sales team prioritize the prospects and helping your marketing and
                                        sales team identify where each prospect is in the buying funnel and analyze the
                                        CRM data, behavior, social data streams, IoT data, and interactions to more
                                        accurately predict which leads are more likely to convert.
                        ...
                        <div class="lead-management scroll-row d-flex flex-wrap align-items-center">
                            <div class="col-md-6 col-12 order-2 order-md-2">
                                <div id="section-2" class="lmcont">
                                    <p class="fea-tag">AI Data Analyst


                                    </p>
                                    <h3 class="fw-bold mb-15">AI Data Analyst (Coming Soon)</h3>
                                    <p>Unlock powerful insights with our upcoming AI Data Analyst. Analyze trends, gain
                                        actionable recommendations and make smarter decisions.
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-6 col-12 order-1 order-md-1">
                                <img class="img-fluid" src="../assets/img/ai-features/ai4.png" alt="Dynamic Image">
                            </div>
                        </div>
                        <div class="lead-management scroll-row d-flex flex-wrap align-items-center">
                            <div class="col-md-6 col-12 order-1 order-md-2">
                                <img class="img-fluid" src="../assets/img/ai-features/ai6.png" alt="Dynamic Image">
                            </div>
                            <div class="col-md-6 col-12 order-2 order-md-1">
                                <div id="section-3" class="lmcont">
                                    <p class="fea-tag">AI-Powered Ad Copy Writer
                                    </p>
                                    <h3 class="fw-bold mb-15">Purpose-built AI for Ad Copywriting

                                    </h3>
                                    <p>Easily craft an ad copy that converts with PropFlo's AI copywriting solution.
                                        Make content your competitive advantage for better customer engagement and
    ...
    <section class="start-now-area bg-image pt-50 pb-50">
        <div class="container">
            <div class="section-header" id="cta" style="text-align:center">
                <h2 style="color:#08cf65" class="fw-600 wow splt-txt words chars splitting animated" data-splitting>
                    Speed up your sales cycle with easy to use
                    <br>AI-powered Real Estate CRM
   ...
   <button class="btn-propflo">Try PropFlo Now</button>
   </div>
   </div>
   <div class="col-md-6 text-center">
