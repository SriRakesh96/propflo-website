...
<head>
    ...
    <!-- Real Estate Portal & Social Media Integration with CRM | PropFlo -->
    <title>Real Estate CRM Integration | PropFlo</title>
    <meta name="title" content="Real Estate CRM Integration | PropFlo">
    <meta name="description"
        content="PropFlo CRM Integration For Real Estate Business with Social media , IVR and Real Estate Portals">
        ...
        <main>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-12">
                            <p class="banner-tag wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="1500ms"
                                style="text-transform: uppercase;">Third Party Integrations</p>
                            <div class="banner-three__content text-center">
                                <h1 style="color:#fff;" class="wow fadeInUp" data-wow-delay="400ms"
                                    data-wow-duration="1500ms">
                                    Integrate With The Best Business Applications
                                </h1>
                                <p style="color:#fff;" class="wow fadeInUp mb-30" data-wow-delay="800ms"
                                    data-wow-duration="2000ms">
                                    PropFlo CRM connects with all your favourite apps seamlessly and saves time by
            ...
            <div class="container">
                <div class="section-header mt-20 mb-20 text-center">
                    <h2 class="fw-600 wow splt-txt" data-splitting>PropFlo CRM + Your Favourite Application

                    </h2>
                    <p class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="2500ms">
                        Gather all your customer interactions from different channels in one place with PropFlo easy
                        integrations and start managing your real estate business efficiently.</p>
                </div>
                <div class="container-fluid">
                    <div class="row">
                        <div class="lead-management scroll-row d-flex flex-wrap align-items-center">
                            <div class="col-md-6 col-12 order-1 order-md-2">
                                <img class="img-fluid" src="../assets/img/third-party/tpi1.png" alt="Dynamic Image">
                            </div>
                            <div class="col-md-6 col-12 order-2 order-md-1">
                                <div id="section-1" class="lmcont">
                                    <p class="fea-tag">Social Media

                                    </p>
                                    <h3 class="fw-bold mb-15">Social Media Lead Capture Integration</h3>
                                    <p>PropFlo CRM software offers multiple social media channel integration, such as
                                        lead generation ads from Facebook and Google, Web forms, WhatsApp, email and
                                        live chat. With easy and smooth integration with PropFlo all your leads capture
                                        and flow seamlessly within CRM and are routed to specific sales teams.
                                    </p>
                        ...
                        <div class="lead-management scroll-row d-flex flex-wrap align-items-center">
                            <div class="col-md-6 col-12 order-2 order-md-2">
                                <div id="section-2" class="lmcont">
                                    <p class="fea-tag">Real Estate Portals

                                    </p>
                                    <h3 class="fw-bold mb-15">All in One CRM for Multiple Real Estate Portal
                                        Integrations

                                    </h3>
                                    <p>Real estate developers have presence on property portals, and you need not worry
                                        about lead capture and lead flow management; simply connect PropFlo CRM software
                                        to your real estate portal, and leads will start automatically flowing into your
                                        account, and you can manage it efficiently.</p>
                                    <a href="../contact" class="read-more-prop mt-4">
                                        See it in action now
                                        <img src="../assets/img/icons/arw.png" alt="arrow" class="arrow-icon">
                                    </a>
                            ...
                            <div class="col-md-6 col-12 order-1 order-md-1">
                                <img class="img-fluid" src="../assets/img/third-party/tpi2.png" alt="Dynamic Image">
                            </div>
                        </div>
                        <div class="lead-management scroll-row d-flex flex-wrap align-items-center">
                            <div class="col-md-6 col-12 order-1 order-md-2">
                                <img class="img-fluid" src="../assets/img/third-party/tpi3.png" alt="Dynamic Image">
                            </div>
                            <div class="col-md-6 col-12 order-2 order-md-1">
                                <div id="section-3" class="lmcont">
                                    <p class="fea-tag">Telephony
                                    </p>
                                    <h3 class="fw-bold mb-15">Presales + Telephony Call Centre Integration
                                    </h3>
                                    <p>We work with the best IVR telephony provider companies in India and
                                        internationally to provide you with the best telephony support. We are pretty
                                        flexible with both on-premise and cloud telephony solutions based on your
                                        requirements, and we will integrate it in PropFlo for you.</p>
                                    <a href="../contact" class="read-more-prop mt-4">
                                        See it in action now
                                        <img src="../assets/img/icons/arw.png" alt="arrow" class="arrow-icon">
                                    </a>
