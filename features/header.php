                     ...
                     <div class="mega-menu1">
                        <div class="row">
                           ...
                           <div class="column">
                              ...
                              <ul class="menu-list1">
                                 <li class="lim">
                                    <a href="sales-management"> <img src="../assets/img/menu-icons/6.png">
                                       <div class="men-rig">
                                 ...
                                 <li class="lim">
                                    <a href="marketing-automation"> <img src="../assets/img/menu-icons/8.png">
                                       <div class="men-rig">
                                 ...
                                 <li class="lim">
                                    <a href="post-sales-management"> <img src="../assets/img/menu-icons/7.png">
                                       <div class="men-rig">
                  ...
                  <li class="mb-sl">
                     ...
                     <ul class="sub-menu">
                        ...
                        <li style="display: flex; align-items: center; color: #fff;">
                           ...
                           <a href="sales-management"><strong>Sales Management</strong></a>
                        </li>
                        <li style="display: flex; align-items: center; color: #fff;">
                           <img src="../assets/img/menu-icons/8.png">
                           <a href="marketing-automation"><strong>Marketing Management</strong></a>
                        </li>
                        <li style="display: flex; align-items: center; color: #fff;">
                           <img src="../assets/img/menu-icons/7.png">
                           <a href="post-sales-management"><strong>Post-Sales Management</strong></a>
                        </li>
                        ...
                        <div class="row">
                           ...
                           <div class="column">
                              <ul class="menu-list1">
                                 ...
                                 <li class="lim">
                                    <a href="marketing-automation"><img src="../assets/img/menu-icons/12.png">
                                       <div class="men-rig">
                                 ...
                                 <li class="lim">
                                    <a href="lead-management"> <img src="../assets/img/menu-icons/icon41.png">
                                       <div class="men-rig">
                                 ...
                                 <li class="lim">
                                    <a href="reports-and-dashboards"><img src="../assets/img/menu-icons/15.png">
                                       <div class="men-rig">
                           ...
                           <div class="column">
                              <ul class="menu-list1">
                                 ...
                                 <li class="lim">
                                    <a href="third-party-integrations"><img src="../assets/img/menu-icons/icon42.png">
                                       <div class="men-rig">
                                 ...
                                 <li class="lim">
                                    <a href="omni-channel-communication">
                                 ...
                                 <li class="lim">
                                    <a href="channel-partner-management"> <img src="../assets/img/menu-icons/17.png">
                                       <div class="men-rig">
                                 ...
                                 <li class="lim">
                                    <a href="mobile-app"> <img src="../assets/img/menu-icons/11.png">
                                       <div class="men-rig">
                           ...
                           <div class="column">
                              <ul class="menu-list1">
                                 <li class="lim">
                                    <a href="ai-features"> <img src="../assets/img/menu-icons/17.png">
                                       <div class="men-rig">
                                 ...
                                 <li class="lim">
                                    <a href="inventory-management"> <img src="../assets/img/menu-icons/16.png">
                                       <div class="men-rig">
                                 ...
                                 <li class="lim">
                                    <a href="customer-app"> <img src="../assets/img/menu-icons/icon40.png">
                                       <div class="men-rig">
                  ...
                  <li class="mb-sl">
                     ...
                     <ul class="sub-menu">
                        ...
                        <li style="display: flex; align-items: center; color: #fff;">
                           ...
                           <a href="marketing-automation"><strong>Marketing Automation</strong></a>
                        </li>
                        ...
                        <li style="display: flex; align-items: center; color: #fff;">
                           ...
                           <a href="lead-management"><strong>Lead Management</strong></a>
                        </li>

                        <li style="display: flex; align-items: center; color: #fff;">
                           <img src="../assets/img/menu-icons/15.png">
                           <a href="reports-and-dashboards"><strong>Reports & Dashboards</strong></a>
                        </li>

                        <li style="display: flex; align-items: center; color: #fff;">
                           <img src="../assets/img/menu-icons/icon42.png">
                           <a href="third-party-integrations"><strong>Third Party Integrations</strong></a>
                        </li>

                        <li style="display: flex; align-items: center; color: #fff;">
                           <img src="../assets/img/menu-icons/13.png">
                           <a href="omni-channel-communication"><strong>Omni Channel Communication</strong></a>
                        </li>
                        <li style="display: flex; align-items: center; color: #fff;">
                        ...
                        <li style="display: flex; align-items: center; color: #fff;">
                           ...
                           <a href="channel-partner-management"><strong>Channel Partner Management</strong></a>
                        </li>
                        ...
                        <li style="display: flex; align-items: center; color: #fff;">
                           ...
                           <a href="inventory-management"><strong>Inventory Management</strong></a>
                        </li>
                        ...
                        <li style="display: flex; align-items: center; color: #fff;">
                           ...
                           <a href="customer-app"><strong>Customer Portal/App</strong></a>
                        </li>
                     ...
                     <div class="mega-menu">
                        <div class="row">
                           ...
                           <div class="column">
                              <ul class="menu-list1">
                                 <li class="lim">
                                    <a href="third-party-integrations"> <img src="../assets/img/menu-icons/23.png">
                                       <div class="men-rig">
                  ...
                  <li class="mb-sl">
                     ...
                     <ul class="sub-menu">
                        ...
                        <li style="display: flex; align-items: center; color: #fff;">
                           ...
                           <a href="third-party-integrations"><strong>Integrations</strong></a>
                        </li>
                        <li style="display: flex; align-items: center; color: #fff;">
