   ...
   <div id="feature-content">
      <div id="artificialIntelligence" class="feature-description text-start">
         <div class="row">
            ...
            <div class="col-md-5 cont-ofer">
               <h2 class="mb-15 mt-10">AI Features</h2>
               <p>Make smarter business decisions with intelligent features like AI Sales assistant, AI Content
                  generator, predictive analytics, automated lead scoring, and customer insights.</p>
               <ul class="feature-list">
                  <li>AI Web Bot - 24x7 Engagement on website, Ability to schedule call/site visit</li>
                  <li>AI Content Writer</li>
                  <li>Lead Scoring -
                     AI Data Analyst - (coming soon)
                  </li>
                  <li>AI based Ad Copy Writer (coming soon)</li>
               </ul>
               <a href="features/ai-features" class="read-more-prop mt-4"> Read more
                  <img src="assets/img/icons/arw.png" alt="arrow" class="arrow-icon"></a>
            </div>
         </div>
      </div>
      <div id="salesAutomation" class="feature-description text-start" style="display: none;">
         <div class="row">
            ...
            <div class="col-md-5 cont-ofer">
               <h2 class="mb-15 mt-10">Sales Management</h2>
               <p>Manage and nurture real estate leads, track customer interactions to drive successful sales outcomes.
               </p>
               <ul class="feature-list">
                  <li> Task Automation</li>
                  <li>Automated Follow-ups</li>
                  <li>Pipeline Customization</li>
                  <li>Site Visit Management</li>
                  <li>Cost Sheet Generator/Sharing</li>
                  <li>Inventory Availablity/Booking/Blocking</li>
                  <li><a href="features/mobile-app" style="text-decoration:none">Sales Mobile App</a></li>
               </ul>
               <a href="features/sales-management" class="read-more-prop mt-4"> Read more
                  <img src="assets/img/icons/arw.png" alt="arrow" class="arrow-icon"></a>
            </div>
         </div>
      </div>
      <div id="marketingAutomation" class="feature-description text-start" style="display: none;">
         <div class="row">
            ...
            <div class="col-md-5 cont-ofer">
               <h2 class="mb-15 mt-10">Marketing Automation</h2>
               <p>Boost your efficiency by automating repetitive tasks, such as lead follow-ups, sales and marketing
                  campaigns.</p>
               <ul class="feature-list">
                  <li> Automated Lead Capture & Nurturing</li>
                  <li> Communication Automation</li>
                  <li> Whatsapp Marketing</li>
                  <li> Bulk Messaging</li>
                  <li> Marketing Workflow Automation</li>
                  

               </ul>
               <a href="features/marketing-automation" class="read-more-prop mt-4"> Read more
                  <img src="assets/img/icons/arw.png" alt="arrow" class="arrow-icon"></a>
            </div>
         </div>
      </div>
      <div id="lead" class="feature-description text-start" style="display: none;">
         <div class="row">
            ...
            <div class="col-md-5 cont-ofer">
               <h2 class="mb-15 mt-10">Lead Management</h2>
               <p>Tag Leads Internally and Externally with PropFlo's Real Estate Lead Management
               </p>
               <ul class="feature-list">
                  <li> Lead capture from Multiple Channels</li>
                  <li>Lead Scoring</li>
                  <li>Lead Insights</li>
                  <li>Lead Assignment Rule</li>
                  <li>Lead Segmentation</li>
                  <li>Lead Conflict for CP and Other Channels</li>
               </ul>
               <a href="features/lead-management" class="read-more-prop mt-4"> Read more
                  <img src="assets/img/icons/arw.png" alt="arrow" class="arrow-icon"></a>
            </div>
         </div>
      </div>
      <div id="omniChannel" class="feature-description text-start" style="display: none;">
         <div class="row">
            ...
            <div class="col-md-5 cont-ofer">
               <h2 class="mb-15 mt-10">Omni Channel Communication</h2>
               <p>PropFlo enables seamless communication across multiple channels— Email, WhatsApp, Customer Portal</p>
               <ul class="feature-list">
                  <li>Real-Time Engagement with Live Tracking and Logs.</li>
                  <li>Two Way Whatsapp Integration</li>
                  <li>Personalised Emails</li>
                  <li>Bulk Emails</li>
                  <li>Track Emails Status</li>
                  <li>Telephony</li>
               </ul>
               <a href="features/omni-channel-communication" class="read-more-prop mt-4"> Read more
                  <img src="assets/img/icons/arw.png" alt="arrow" class="arrow-icon"></a>
            </div>
         </div>
      </div>
      <div id="postsales" class="feature-description text-start" style="display: none;">
         <div class="row">
            ...
            <div class="col-md-5 cont-ofer">
               <h2 class="mb-15 mt-10">Post Sales Management</h2>
               <p>PropFlo Real Estate CRM software automates post-sales tasks and allows salespeople to focus more on
                  converting new leads.
               </p>
               <ul class="feature-list">
                  <li>Booking Management</li>
                  <li>Payment Management</li>
                  <li>Milestone,Collection Management</li>
                  <li>Demand Note Automation</li>
                  <li>Whatsapp/Email Communication</li>
                  <li>Checklist & Handover</li>
                  <li>Task Management</li>
                  <li>AOS, Sale Deed Generator, etc</li>
                  <li> Bulk Upload Management</li>
               </ul>
               <a href="features/post-sales-management" class="read-more-prop mt-4"> Read more
                  <img src="assets/img/icons/arw.png" alt="arrow" class="arrow-icon"></a>
            </div>
         </div>
      </div>
      <div id="inventory" class="feature-description text-start" style="display: none;">
         <div class="row">
            ...
            <div class="col-md-5 cont-ofer">
               <h2 class="mb-15 mt-10">Inventory Management</h2>
               <p>Oversee and maintain your units sold to owners.</p>
               <ul class="feature-list">
                  <li>Real Time Inventory Creation and Update
                  </li>
                  <li>Grid & List View
                  </li>
                  <li>Creation of Milestones
                  </li>
                  <li>Bulk Import Inventory
                  </li>
                  <li>Interactive Dashboards
                  </li>
                  <li>Custom Parking Allocation Rules
                  </li>
                  <li>Checklist and Handover</li>
               </ul>
               <a href="features/inventory-management" class="read-more-prop mt-4"> Read more
                  <img src="assets/img/icons/arw.png" alt="arrow" class="arrow-icon"></a>
            </div>
         </div>
      </div>
