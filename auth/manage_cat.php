                     ...
                     <div class="card-body">
                        <div class="table-responsive">
                           <table id="student_data" class="table table-striped table-bordered">
                              ...
                              <?php  
                                 $jquery ="SELECT * FROM propflo_category ORDER BY id DESC";  
                                                     ...
                                                     <td>$cat_name</td>
                                                      ...
                                                      <div class=\"dropdown\">
                                                          ...
                                                          <div class=\"dropdown-menu\">
                                                              ...
                                                              <a class=\"dropdown-item\" href=\"delete_cat?cat_id=$cat_id\" onclick=\"return confirm('Are you sure want to delete category');\">Delete Category</a>
                                         </div>
                                                      </div>
                                                  </td>
