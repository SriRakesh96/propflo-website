                           ...
                           <table id="student_data" class="table table-striped table-bordered">
                              <thead>
                                 <tr>
                                    ...
                                    <th width="30%"><strong>Blog Title</strong></th>
                              ...
                              <?php  
                                 $jquery ="SELECT * FROM propflo_blogs ORDER BY id DESC";  
                                                     ...
                                                     <td>$added</td>
                                                      ...
                                                      <div class=\"dropdown\">
                                                          ...
                                                          <div class=\"dropdown-menu\">
                                                              ...
                                                              <a class=\"dropdown-item\" href=\"edit_news?news_id=$news_id\">Edit Blog</a>
                                                              
                                                             
                                                              <a class=\"dropdown-item\" href=\"delete_news?news_id=$news_id&im=$news_img\" onclick=\"return confirm('Are you sure want to delete news?');\">Delete Blog</a>
                                         </div>
                                                      </div>
                                                  </td>
