...
<td  bgcolor="#FFFFFF"><strong>Date</strong></td>
 ...
 <?php  
                                 $query ="SELECT * FROM propflo_contact WHERE form='Contact_Us' AND act='1' ORDER BY id DESC limit $row,".$rowperpage;
...
if($result){echo "<meta http-equiv=\"refresh\" content=\"0;URL=contact_form.php\">";}}
mysqli_close($conn);
?>
