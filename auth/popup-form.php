               ...
               <div class="col-lg-12">
                  <div class="card">
                     <div class="card-header">
                        <h4 class="card-title">Manage Exit Popup Form Messages</h4>
                     </div>
                     <div class="card-body">
...
<td  bgcolor="#FFFFFF"><strong>Date</strong></td>
 ...
 <?php  
                                 $query ="SELECT * FROM propflo_contact WHERE  form='Popup_Form' AND act='1' ORDER BY id DESC limit $row,".$rowperpage;
